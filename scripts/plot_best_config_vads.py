print ("""
========================plot_best_campaign_vads.py========================
Plots DREAM VAD spread per scenario for each campaign
...
if (len(sys.argv) != 2):
	print('Usage : plot_best_campaign_vads.py <csv file>\n')
	exit()

# Arguments
csvfile=sys.argv[1]
#csvfile='C:\\Users\\whit162\\OneDrive - PNNL\\Documents\\Projects\\DreamProject\\Results_20191205155836\\best_campaign_vads.csv'
...
new_folder = os.path.join(os.path.dirname(csvfile) + '/best_campaign_vad_plots')
print(new_folder)
...
for x in to_plot_list:
    ...
    ax.set_title('Campaign_%d - Number of Scenarios Detected by VAD'%(i+1))
    ax.set_xticks(ind)
